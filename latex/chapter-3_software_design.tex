...
\label{sec:software_design:data_collection}
    As we have shown in \ref{subsec:related:pii} and \ref{subsec:related:law} it is wise to avoid the collection of PII. While it can be avoided for the statistical data and numeric values, that may identify device can be categorized as recommended in \cite{mccallister_guide_2010},
    this might not be possible for ID generation.\\
