...
\section{Data Anonymization}
    ...
    \subsection{Private Data Publication}
        ...
        \subsubsection{\textit{l}-diversity}
            ...
            In \cite{machanavajjhala_l-diversity_2007} Machanavajjhala et al. show, that k-anonymity is succeptable the two attack vectors homogenity and background knowledge.
            The homogenity attack works on datasets with groups that lack diversity in sensitive attributes. The background knowledge attack on the other hand uses available knowledge in addition to the provided dataset, that is not directly matched to attributes.
