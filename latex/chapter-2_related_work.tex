...
\section{Data Anonymization}
    ...
    -
    The US National Institute of Standards and Technology (NIST) define  \cite{mccallister_guide_2010}
...
\section{Summary}
    ...
    The Domain Name System provides us a hierarchical structure, that strips the senders information
    from the transmitted data in a reliable way. A user, can have trust in that and doesn't depend on an organization to handled that properly. Utilizing the name system faces new issues that need to be handled and will be discussed in the next chapter.\\ 
